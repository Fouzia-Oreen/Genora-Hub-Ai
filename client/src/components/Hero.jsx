...
const Hero = () => {
  ...
  return (
    <div
      className="relative bg-cover bg-no-repeat bg-center min-h-[85vh]"
    ...
    >
      ...
      <div className="absolute z-20 flex flex-col justify-center items-center text-center h-full w-full px-4 sm:px-20 xl:px-32 ">
        ...
        <SparklesIcon className="w-5 h-5 text-color_11 animate-sparkle" />
         Create Smarter, Launch Faster Built for Creators & Professionals
        </p>
        ...
        <p className="md:text-lg text-sm text-color_3 max-w-2xl mb-4 mt-10">

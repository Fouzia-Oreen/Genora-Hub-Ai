...
const SkillInfoForm = ({skillsInfo,updateArrayItem, addArrayItem,removeArrayItem,}) => {
  return (
    <div className='py-5 '>
        <h2 className='text-lg font-semibold text-color_4'>Skills</h2>
                ...
                <div className="relative mb-2 border-b border-dashed border-color_3/30  pb-4" key={index}>
                   <Input
                    ...
                    <div className='flex flex-col'>
                      <label className="text-sm font-semibold text-color_4/80 mb-1">Proficiency ({skill.progress / 20 || 0}/5)</label>
                      <div className='mt-3'>
                        <RatingInput value={skill.progress || 0} total={5} onChange={(value) => updateArrayItem(index, "progress", value)} activeColor="#2563EB" inActiveColor="#c6d2f3"/>
                      </div>
                    </div>
